...
CAMINHO_ZIP_DIR = CAMINHO_RAIZ / 'aula_25_diretorio_zip'
CAMINHO_COMPACTADO = CAMINHO_RAIZ / 'aula25_compactado.zip'
CAMINHO_DESCOMPACTADO = CAMINHO_RAIZ / 'aula25_descompactado'
